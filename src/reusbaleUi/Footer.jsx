        ...
        <div className="max-w-[90%] mx-auto">
          <div className="py-6 max-md:px-0 max-md:py-0 md:hidden">
            ...
            >
              ...
              <div className="flex items-center justify-between gap-12 max-md:flex max-md:flex-col max-md:gap-4">
          ...
          <div className="grid grid-cols-2 sm:gap-6 max-md:grid-cols-1">
            <div className="space-y-20 py-6 max-md:pb-0">
              <div>
                ...
                <p className="text-base max-md:text-sm text-white leading-normal tracking-wide max-w-[50ch]">
                  We provide reliable plumbing services for homes and
                  businesses. Our team focuses on quality work, clear pricing,
