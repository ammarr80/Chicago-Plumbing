  ...
  return (
    <header className="max-w-[90%] mx-auto">
      ...
      <nav
        id="navbar"
        ref={navRef}
        class="bg-primary w-full hidden max-md:hidden fixed px-16 py-3 top-0 left-0 z-50 flex items-center justify-between"
      >
        <h2 class="font-bold text-3xl max-md:text-2xl text-white">
          Chicago Plumbing
        </h2>
        <div class="flex items-center gap-14 relative">
          ...
          <a
            href="#footer"
            class="bg-white text-black px-9 py-3 rounded-md font-semibold"
          >
            Contact
          </a>
          <div class="flex items-center gap-5">
            <a
              ...
              class="flex items-center gap-4 bg-primary border shadow-2xl border-black text-white font-semibold px-4 py-3 rounded-lg"
            >
