...
export default function ServiceAreas() {
  return (
    <>
      <section
        id="service-areas"
        className="max-w-[90%] items-center mx-auto grid lg:grid-cols-2 gap-6 grid-cols-1"
      >
        <div>
          <div className="max-md:mb-5">
            <h2 className="font-bold text-4xl mb-5">Our Service Areas</h2>
            <p className="text-gray-600 max-w-[70ch] leading-normal text-base mb-9">
            ...
            <ul className="space-y-4 mb-12 md:max-w-[90%] grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-4">
        ...
        <div className="p-6 max-md:p-0 rounded-lg">
          <h4 className="font-bold text-center mb-2 text-2xl">
            Find Us On Map
          </h4>
          ...
          <iframe
            ...
            className="w-full md:max-w-[90%] mx-auto h-100 map rounded-lg mb-8 border-8 border-white"
            allowfullscreen=""
            loading="lazy"
